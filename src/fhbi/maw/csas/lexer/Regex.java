...
/**
 * Diese Klasse beschreibt reguläre Ausdrücke. Zusätzlich können in den
 * Konstruktoren HTML-Formatierungen festgelegt werden.
 * 
...
public abstract class Regex {
	...
	/**
	 * Erzeugt eine Instanz mit übergebenen Parametern und der Schriftfarbe
	 * schwarz.
	 * 
	 * @param name
	 *            Name des Regex-Objektes
	 * @param regexString
	 *            Ausdruck des Regulären Ausdruckes
	 */
	 ...
	 *            Ausdruck des Regulären Ausdruckes
	 * @param htmlColor
	 *            Schriftfarbe in der HTML-Ansicht
	 */
	 ...
	 * Diese Methode wird von startsWithRegex() aufgerufen, wenn eine
	 * Zeichenkette diesen regulären Ausdruck am Anfang findet!
	 * 
	 * @param expression
	 *            Gefundener Ausdruck in der Zeichenkette
	 */
	...
	/**
	 * Gibt die gespeicherte Zeichenkette, passend zum regulären Ausdruck,
	 * wieder
	 * 
	 * @return gefundener Ausdruck in der Zeichenkette, wenn festegelegt. Sonst
	 *         "" (leerer String)
	 */
	 ...
	 * Zeichenkette passt. Ist dies der Fall, wird die gefundene Zeichenkette in
	 * diesem Objekt mit {@link #setExpression(String)} gespeichert.
	 * 
	 * @param expression
	...
	/**
	 * Gibt die Zeichenkette mit festgelegten HTML-Formatierungen zurück
	 * 
	 * @return gespeicherte Zeichenkette in HTML-Form
	 */
	public String getHTMLTag() {
		String html = "<font color=\"" + _htmlColor + "\">";
		if (_htmlArt != null)
			html += "<" + _htmlArt + ">"
					+ this.getExpression().replace("\n", "<br>") + "</"
					+ _htmlArt + ">";
		else
			html += this.getExpression().replace("\n", "<br>");
		html += "</font>";
